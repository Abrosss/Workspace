...
Note: _during production process one dev account is used by default, a connection to the database happens through API, so you can focus on bugtracker features and issues_ <br />
